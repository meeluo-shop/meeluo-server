...
export class AdminMerchatUserDTO {
  @ApiProperty({
    description: '电子邮箱',
  })
...
export class AdminModifyMerchantDTO {
  @ApiProperty({
    description: '商户名称',
  })
  ...
  @Type(() => AdminMerchatUserDTO)
  @ValidateNested()
  adminUser: AdminMerchatUserDTO;
}

export class AdminMerchantIdDTO {
  @ApiProperty({
    description: '商户id',
  })
  @Type(() => Number)
...
export class AdminMerchantActiveDTO {
  @ApiProperty({
    required: false,
    enum: MerchantIsActiveEnum,
...
export class AdminMerchantDetailResp {
