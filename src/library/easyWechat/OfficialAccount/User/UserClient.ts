...
export default class UserClient extends BaseClient {
   ...
   */
  get(openid: string, lang = 'zh_CN'): Promise<ClientUserInfo> {
   ...
   * @param lang 语言，默认：zh_CN
   */
  select(openids: Array<string>, lang = 'zh_CN'): Promise<any> {
    const user_list: Array<object> = [];
